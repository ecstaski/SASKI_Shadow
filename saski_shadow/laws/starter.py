...
STARTER_LAWS: tuple[dict[str, str], ...] = (
    ...
    },
    {
        ...
        "note": "The primary federal prohibition on unfair or deceptive acts or practices in commerce, enforced by the Federal Trade Commission. Applies to conversational AI systems that make false or misleading claims about their nature or capabilities, fail to disclose AI identity when material to the consumer, impersonate licensed professionals, or otherwise engage in deceptive practices affecting consumers. The FTC has actively applied this statute to AI products through enforcement actions including Operation AI Comply.",
    },
    {
        "law_id": "US-COPPA",
        "jurisdiction": "US",
    ...
    },
    {
        ...
        "date_added": "2026-06-22",
        "note": "Federal criminal prohibitions on the production (§ 2251), distribution, receipt, and possession (§ 2252), and trafficking in child pornography as defined in § 2256 (§ 2252A). Federal jurisdiction applies when interstate commerce, including internet use, is involved. Section 2256 defines child pornography as any visual depiction of sexually explicit conduct involving a minor. Section 2252A uses the broader defined term child pornography and applies to computer-generated depictions where the material is virtually indistinguishable from a depiction of an actual minor. Sections 2251 and 2252 date to the Protection of Children Against Sexual Exploitation Act of 1977 (Pub. L. 95-225, enacted February 6, 1978); § 2252A added by Pub. L. 104-208 (1996).",
    },
    {
        ...
        "date_added": "2026-06-22",
        "note": "Requires electronic communication service providers and remote computing services that obtain actual knowledge of apparent child pornography on their systems or services to make an immediate report to the National Center for Missing and Exploited Children (NCMEC) CyberTipline. Knowing and willful failure to report is a federal offense. Enacted as part of the PROTECT Our Children Act of 2008 (Pub. L. 110-401, signed October 13, 2008).",
    },
    {
    ...
    },
    {
        ...
        "date_added": "2026-06-22",
        "note": "Establishes national standards for the protection of individually identifiable health information (protected health information, or PHI). Applies to covered entities — health plans, health care clearinghouses, and health care providers who transmit health information electronically in connection with HIPAA-covered transactions — and their business associates. Conversational AI systems operated by or on behalf of a covered entity or business associate that create, receive, maintain, or transmit PHI are subject to the Privacy Rule (45 CFR Part 164 Subpart E), Security Rule (45 CFR Part 164 Subpart C), and Breach Notification Rule (45 CFR Part 164 Subpart D). Also applies in mental health contexts when the operator is a covered entity or business associate. Statute enacted August 21, 1996 (Pub. L. 104-191); Privacy Rule compliance date April 14, 2003.",
    },
)
