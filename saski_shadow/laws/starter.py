...
STARTER_LAWS: tuple[dict[str, str], ...] = (
    ...
    },
    {
        ...
        "effective_date": "2027-07-01",
        "date_added": "2026-06-17",
        "note": "Operators of conversational AI services must clearly and conspicuously disclose non-human status to users if a reasonable person would be misled into believing they are interacting with a human. Heightened disclosure obligations apply to minor account holders. Operators may not represent the service as designed to provide professional mental or behavioral health care. Enforced exclusively by the Attorney General with civil penalties of $1,000–$500,000 per operator. No private right of action. Developer of an AI model is not liable for violations by a third-party operator.",
    },
    {
    ...
    },
    {
        ...
        "note": "Requires vendors of personal health records (PHRs) and related entities not covered by HIPAA to notify individuals, the FTC, and in some cases the media of a breach of unsecured personally identifiable health data. The 2024 amendments (effective July 29, 2024) explicitly extended coverage to health apps, fitness trackers, and other digital health tools that collect, infer, or transmit health-related information. An AI chatbot or conversational health tool that collects or infers health data and is not a HIPAA-covered entity or business associate is subject to this rule. Violations carry civil penalties up to $53,088 per incident. The rule is enforced by the FTC.",
    },
    {
        ...
        "date_added": "2026-06-23",
        "note": "Protects the confidentiality of substance use disorder (SUD) patient records for federally assisted programs. The 2024 final rule (effective April 16, 2024, compliance required by February 16, 2026) aligned Part 2 more closely with HIPAA, permitting a single consent for all future uses and disclosures for treatment, payment, and healthcare operations. Part 2 records may only be disclosed with patient written consent or under narrowly defined exceptions. AI systems operating in SUD treatment contexts — including conversational intake tools, clinical scribes, and care coordination assistants — that access or transmit Part 2-protected records are subject to these confidentiality requirements. The rule prohibits use of Part 2 records in criminal or civil proceedings without consent or a court order. Enforcement transferred to HHS Office for Civil Rights in August 2025.",
    },
    {
        "law_id": "US-ADEA",
        "jurisdiction": "US",
        ...
        "date_added": "2026-06-23",
        "note": "Prohibits employment discrimination against workers aged 40 or older. Applies to private employers with 20 or more employees, as well as state and local governments regardless of size. AI-assisted hiring, screening, and candidate ranking tools are subject to ADEA when they produce disparate impact on workers aged 40 or older. The EEOC withdrew its AI-specific technical assistance documents in early 2025 following the executive order on AI deregulation; the underlying statutory obligations remain fully in force. Employers deploying AI employment decision tools remain liable for age-discriminatory outcomes under the ADEA and the Uniform Guidelines on Employee Selection Procedures (UGESP, 29 CFR Part 1607).",
    },
    {
        "law_id": "US-FCRA",
        "jurisdiction": "US",
        ...
        "date_added": "2026-06-23",
        "note": "Regulates consumer reporting agencies and the use of consumer reports for employment purposes. AI tools that score, rank, or filter job applicants using data assembled from third-party sources may qualify as consumer reports under the FCRA, subjecting the provider to consumer reporting agency obligations. Employers using such tools must provide standalone disclosures, obtain written authorization before procuring reports, and deliver pre-adverse action notices before making adverse employment decisions. The CFPB confirmed in 2024 that algorithmic hiring scores and background dossiers used for employment decisions are subject to FCRA regardless of whether they are generated by AI software. Enforcement by the FTC and CFPB; private right of action available to affected consumers.",
    },
    {
        "law_id": "US-ACA-1557",
        "jurisdiction": "US",
